...
public class CacheUtils {
    ...
    public static void clearLevel2Cache(EntityManagerFactory emf) {
        Cache cache = CacheUtils.getCache(emf);
    ...
    public static void evictEntity(EntityManager entityManager,Class  clazz, Serializable id){
    	 Cache cache = CacheUtils.getCache(entityManager.getEntityManagerFactory());
    	 
    	cache.evictEntity(clazz, id);
    }
