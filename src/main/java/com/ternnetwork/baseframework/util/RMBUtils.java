...
public class RMBUtils {
	...
	*/
	  ...
	  public static void main(String[] args) {
	    System.out.println(RMBUtils.toBigAmt(10052345.00D));
	    System.out.println(RMBUtils.toBigAmt(0.00D));
	    System.out.println(RMBUtils.toBigAmt(0.60D));
	    System.out.println(RMBUtils.toBigAmt(00.60D));
	    System.out.println(RMBUtils.toBigAmt(150.2101D));
	    System.out.println(RMBUtils.toBigAmt(15400089666.234D));
	    System.out.println(RMBUtils.toBigAmt(22200004444.2347D));
	  }
}
