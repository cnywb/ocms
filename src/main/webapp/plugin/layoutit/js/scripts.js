  ...
  var editor;
    function initEditor(){
		...
		var cssPathes=new Array();
         //cssPathes.push('../layoutit/css/bootstrap-combined.min.css');
		//
		cssPathes.push('../kindeditor/plugins/code/prettify.css');
		 var scriptPathes=new Array();
         scriptPathes.push('../layoutit/js/jquery-2.0.0.min.js');
		 scriptPathes.push('../layoutit/js/bootstrap.min.js');
       	KindEditor.ready(function(K) {
    		 editor= K.create('#contenteditor', {
      			cssPath:cssPathes,
				//scriptPath:scriptPathes,
    			filterMode : false,
    			uploadJson:base+'/common/kindeditor/upload.jhtml;jsessionid='+sessionId+"?AUTH_ID="+auth_id+"&needWaterMark=true", //���ļ��ϴ�ʱ�������
