...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData,scriptPath) {
	var arr = [
	...
	if (!_isArray(scriptPath)) {
		scriptPath=[scriptPath];
	}
	_each(scriptPath, function(i, path) {
		if (path) {
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		function ready() {
			...
			doc.write(_getInitHtml(themesPath, bodyClass, cssPath, cssData,scriptPath));
			doc.close();
