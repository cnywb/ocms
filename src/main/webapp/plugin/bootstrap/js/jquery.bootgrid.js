...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "",
            infos: "显示 {{ctx.start}} 到 {{ctx.end}} 共 {{ctx.total}} 条",
            loading: "加载中...",
            noResults: "无结果!",
            refresh: "刷新",
            search: "查找"
         ...
         **/
        templates: {
            actionButton: "<button style=\"width:34px;height:34px\" class=\"btn btn-default\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button>",
