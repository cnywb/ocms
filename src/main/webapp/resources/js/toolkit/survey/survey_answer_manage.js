...
function save(){
	var submitData=getParams('addModal');
	  ...
	  submitData["question.id"]=$("#questionId").val();
	  $('#addModal').modal('hide');

	$.ajax( {
		url :'toolkit/survey/answer/add.htm',
		type : 'post',
		dataType:'text',
		data:submitData,
...
function update(){
	...
	$.ajax( {
		url :'toolkit/survey/answer/update.htm',
		type : 'post',
		dataType:'text',
		data:submitData,
		success : function(result) {
...
function getQueryParams(containerId,submitData){
 ...
 function doDelete(delId){
       ...
       $.ajax( {
 			url :'toolkit/survey/answer/delete.htm',
 			type : 'post',
 			data: 'id='+delId,
 			dataType:'text',
 			success : function(result) {
