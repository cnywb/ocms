...
function itemManage(){
	...
	window.parent.addTabs({id: "vote_item_manage", title: "选项设置", url: 'toolkit/vote/item/manage.htm?voteId='+voteId, close: true});
}
function result(){
	var voteId=$("#voteId").val();
