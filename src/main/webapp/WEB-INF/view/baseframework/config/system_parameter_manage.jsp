...
<div class="container-fluid">
    ...
    <div class="form-inline" role="form">
     ...
     <br>
      <table class="table-responsive" id="data_table" data-url="<c:url value='/baseframework/config/systemparameter/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
        ...
        <div class="container-fluid">
          ...
          <br>
           <div class="row">
             ...
             <input type="text" name="paramKey" class="form-control" placeholder="键" aria-describedby="sizing-addon2" data-toggle="popover" data-placement="top" data-content="请填大写英文字母">
             </div>
          </div> 
           <br>
           <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">值</span>
             <input type="text"  name="paramValue" class="form-control" placeholder="值" aria-describedby="sizing-addon2"   >
             </div>
           </div>
             <br>
            <div class="row">
             ...
             <input type="text"  name="category" class="form-control" placeholder="分类" aria-describedby="sizing-addon2" data-toggle="popover" data-placement="top" data-content="请填大写英文字母"  >
             </div>
           </div> 
             <br>   
            <div class="row">
             ...
             <input type="text"  name="description" class="form-control" placeholder="备注" aria-describedby="sizing-addon2"   >
             </div>
            </div>                  
         </div>
      </div>
...
<div class="modal fade" role="dialog" id="editModal" aria-labelledby="gridSystemModalLabel">
  ...
  <div class="modal-dialog" role="document">
    ...
    <script src="<c:url value='/resources/js/baseframework/config/system_parameter_manage.js' />"></script>
