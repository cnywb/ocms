...
<div class="container-fluid">
   ...
   <br>
    <div class="form-inline" role="form">
     ...
     <br>
    <table id="data_table"  data-url="<c:url value='/baseframework/security/role/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
             ...
             <input type="text" name="nameZh" class="form-control" placeholder="角色名称" aria-describedby="sizing-addon2" >
             </div>
          </div>
          <br>
           <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">角色代码</span>
             <input type="text" name="nameEn" class="form-control" placeholder="角色代码" aria-describedby="sizing-addon2" data-toggle="popover" data-placement="top" data-content="请填写大写英文字母">
             </div>
          </div> 
...
<div class="modal fade" role="dialog" id="editModal" aria-labelledby="gridSystemModalLabel">
  ...
  <div class="modal-dialog" role="document">
   ...
   <c:import url="/WEB-INF/view/include/color_admin_footer.jsp"/>
     ...
     <script src="<c:url value='/resources/js/baseframework/security/role_manage.js' />"></script>
