...
<div class="container-fluid">
   ...
   <br>
    <div class="form-inline" role="form">
     ...
     <br>
    <table id="data_table"  data-url="<c:url value='/toolkit/luckydraw/award/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
      ...
      <div class="modal-body">
        <div class="container-fluid">
          ...
          <div class="row">
             ...
             <input type="text" name="grade" class="form-control" placeholder="请填写级别" aria-describedby="sizing-addon2" >
             </div>
          </div>
          <br>
           <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">总数</span>
             <input type="text" name="quantity" class="form-control" placeholder="请填写正整数" aria-describedby="sizing-addon2" >
             </div>
          </div> 
           <br>
           <div class="row">
             ...
             <input type="text" name="memo" class="form-control"  aria-describedby="sizing-addon2">
             </div>
          </div> 
         </div>
      </div>
        ...
        <div class="container-fluid">
          ...
          <br>
           ...
           <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">备注</span>
             <input type="text" name="memo" class="form-control" placeholder="" aria-describedby="sizing-addon2" >
             </div>
          </div> 
         </div>
      </div>
...
<script src="<c:url value='/resources/js/toolkit/luckydraw/lucky_draw_award_manage.js' />"></script>
