...
<div class="container-fluid">
 ...
 <c:if test="${luckyDrawId==null}">
      ...
      <div class="panel-body" id="query_con">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
          <input type="text" name="startTime" class="form_datetime form-control" placeholder="中奖开始时间">
          </div>
            <div class="form-group">
             <input type="text" name="endTime" class="form_datetime form-control" placeholder="中奖结束时间">
            </div>
            <div class="form-group">
   ...
   <div class="span12">
    <br>
    <table id="data_table"  data-url="<c:url value='/toolkit/luckydraw/result/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
    </thead> 
   </table> 
    </div>
...
<script src="<c:url value='/resources/js/toolkit/luckydraw/lucky_draw_result_manage.js' />"></script>
