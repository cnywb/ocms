   ...
   <br>
    <div class="form-inline" role="form">
        <div class="form-group">
            ...
            <div class="input-group">
                 <button type="button" class="btn btn-primary btn-sm" onclick="templateManage('${campaignCode}');" >模版文件管理</button>
            </div>
            <div class="input-group">
                 <button type="button" class="btn btn-primary btn-sm"  onclick="resourcesManage('${campaignCode}');" >资源文件管理</button>
            </div>
        </div>
     </div>
     <br>
    <table id="data_table"  data-url="<c:url value='/toolkit/infocollection/campaign/page/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
...
<script src="<c:url value='/resources/js/toolkit/infocollection/campaign_page_manage.js' />"></script>
