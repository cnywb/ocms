...
<div class="container-fluid">
    ...
    <div class="panel panel-inverse">
      ...
      <div class="panel-body" id="query_con">
        ...
        <div class="form-group">
          <input type="text" name="code" class="form-control" placeholder="渠道代码">
        </div>
         <div class="form-group">
          <input type="text" name="name" class="form-control" placeholder="渠道名称">
        </div>
       <div class="form-group">
   ...
   <br>
    <div class="form-inline" role="form">
     ...
     <br>
    <table id="data_table"  data-url="<c:url value='/toolkit/infocollection/channel/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
             ...
             <span class="input-group-addon" id="sizing-addon1">渠道代码</span>
          ...
          <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">渠道名称</span>
             <input type="text" name="name" class="form-control" placeholder="渠道名称" aria-describedby="sizing-addon2" >
             </div>
          </div>
...
<script src="<c:url value='/resources/js/toolkit/infocollection/channel_manage.js' />"></script>
