...
<div class="container-fluid">
    ...
    <div class="form-inline" role="form">
     ...
     <br>
    <table id="data_table"  data-url="<c:url value='/toolkit/survey/answer/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          ...
          <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">是否需要说明</span>
          <select  class="form-control" name="needMemo">
...
<script src="<c:url value='/resources/js/toolkit/survey/survey_answer_manage.js' />"></script>
