...
<div class="modal fade" role="dialog" id="editModal" aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="groupManage();">问题分组管理</button>
        <button type="button" class="btn btn-primary" onclick="questionManage();">问题管理</button>
...
<script src="<c:url value='/resources/js/toolkit/survey/survey_manage.js' />"></script>
