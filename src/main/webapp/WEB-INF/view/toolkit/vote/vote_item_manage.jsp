...
<div class="container-fluid">
   ...
   <br>
    <div class="form-inline" role="form">
     ...
     <br>
    <table id="data_table"  data-url="<c:url value='/toolkit/vote/item/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
...
<script src="<c:url value='/resources/js/toolkit/vote/vote_item_manage.js' />"></script>
