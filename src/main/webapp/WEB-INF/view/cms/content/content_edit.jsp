...
<div class="container-fluid" id="content_container">
         ...
         <input type="hidden" value="${t.channel.site.id}" id="siteId" >
         
	        <br>
	        <div class="row-fluid">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">栏目</span>
             <input type="text" readonly value="${t.channel.nameZh}" id="channel" class="form-control" placeholder="栏目" aria-describedby="sizing-addon2" >
              <input type="hidden" name="id"  value="${t.id}"/>
             <input type="hidden" name="channel.id" value="${t.channel.id}" id="channelId" />
             </div>
            </div>
            ...
            <br>
             ...
             <option value="">请选择模板</option>
              <c:forEach var="item" items="${fileNameList}" varStatus="status">
                  <option <c:if test='${t.template==item}'>selected="selected"</c:if>  value="${item}">${item}</option>
              </c:forEach>
             </select>
             </div>
            </div>
           ...
           <div class="row-fluid">
             ...
             <input type="text" name="title" class="form-control" value="${t.title}" placeholder="标题" aria-describedby="sizing-addon2" >
             </div>
          </div>
           <br>
           <div class="row-fluid">
             ...
             <input type="text" name="contentFrom" class="form-control" value="${t.contentFrom}" placeholder="来源" aria-describedby="sizing-addon2" >
             </div>
          </div>
            <br>
            <div class="row-fluid">
             ...
             <input type="text" name="subTitle" value="${t.subTitle}" class="form-control" placeholder="摘要" aria-describedby="sizing-addon2" >
             </div>
          </div>
            <br>
          <div class="row-fluid">
             ...
             <input type="text" name="author" value="${t.author}" class="form-control" placeholder="作者" aria-describedby="sizing-addon2" >
             </div>
          </div>
            <br>
            <div class="row-fluid">
             ...
             <input type="text" readonly value="${t.contentCategory.nameZh}" id="contentCategory" class="form-control" placeholder="类别" aria-describedby="sizing-addon2" >
             <input type="hidden" value="${t.contentCategory.id}" name="contentCategory.id" id="contentCategoryId" />
             </div>
            </div>
           ...
           <option value="false" <c:if test='${t.commentAble==false}'>selected="selected"</c:if> >否</option>
           <option value="true" <c:if test='${t.commentAble==true}'>selected="selected"</c:if> >是</option>
             </select>
             </div>
            </div>
            <br>
          ...
          <br>
           <div class="row-fluid">
            ...
            <textarea name="content" id="contenteditor" cols="100" rows="8" style="width:100%;height:300px;visibility:hidden;">${t.contentString}</textarea>
             </div>
           </div>
           <br>
           <div class="row-fluid">
  ...
  <div class="modal-dialog" role="document">
   ...
   <script src="<c:url value='/plugin/ztree/js/jquery.ztree.core-3.5.js' />"></script>
    ...
    <script src="<c:url value='/resources/js/cms/content/content_edit.js' />"></script>
   </body>
</html>
