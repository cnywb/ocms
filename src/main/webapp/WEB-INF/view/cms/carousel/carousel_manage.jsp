...
<div class="container-fluid">
	...
	<div class="alert alert-info" role="alert">
      <strong>提示：</strong>轮播内容数据接口地址为cms/carousel/content/findByCode.htm?carouselCode=代码
    </div>
    ...
    <div class="form-inline" role="form">
     ...
     <br>
      <table id="data_table" data-url="<c:url value='/cms/carousel/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
...
<div class="modal fade" role="dialog" id="editModal" aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
        <button type="button" class="btn btn-primary" onclick="carouselContentManage();">设置轮播内容</button>
  ...
  <div class="modal-dialog" role="document">
    ...
    <script src="<c:url value='/resources/js/cms/carousel/carousel_manage.js' />"></script>
