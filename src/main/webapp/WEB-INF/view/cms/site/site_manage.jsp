...
<div class="container-fluid">
   ...
   <br>
     ...
     <br>
    <table id="data_table" data-url="<c:url value='/cms/site/query.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
             ...
             <span class="input-group-addon" id="sizing-addon1">站点代码</span>
             <input type="text" name="code" class="form-control" placeholder="站点代码,系统内不重复" aria-describedby="sizing-addon2">
             </div>
          </div> 
            <br>
          <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">站点名称</span>
             <input type="text" name="name" class="form-control" placeholder="站点名称" aria-describedby="sizing-addon2" >
             </div>
          </div>
          <br>
           <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">站点域名</span>
             <input type="text" name="domain" class="form-control" placeholder="站点域名,系统内不重复" aria-describedby="sizing-addon2">
             </div>
          </div>
           <br>
           <div class="row">
            ...
            <select class="form-control" name="status">
               <%
                for(SiteStatus t: SiteStatus.values()){
...
<div class="modal fade" role="dialog" id="editModal" aria-labelledby="gridSystemModalLabel">
      ...
      <div class="modal-body">
        <div class="container-fluid">
          ...
          <br>
           ...
           <div class="row">
             <div class="col-md-12 input-group">
             <span class="input-group-addon" id="sizing-addon1">首页模版</span>
             <select  class="form-control" name="indexTemplate">
  ...
  <div class="modal-dialog" role="document">
    ...
    <script src="<c:url value='/resources/js/cms/site/site_manage.js' />"></script>
   </body>
</html>
