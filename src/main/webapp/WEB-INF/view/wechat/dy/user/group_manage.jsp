...
<div class="container-fluid">
    ...
    <div class="form-inline" role="form">
     ...
     <br>
      <table id="data_table" data-url="<c:url value='/wechat/user/queryDyGroup.htm' />" data-height="400" data-side-pagination="server" data-pagination="true"> 
    <thead> 
     <tr> 
      ...
      <th data-field="count" data-align="center" data-sortable="false">用户数量</th> 
      </tr> 
    </thead> 
   </table> 
     </div> 
...
<div class="modal fade " role="dialog" id="alertModal" aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <script src="<c:url value='/resources/js/wechat/dy/user/group_manage.js' />"></script>
